...
Файли зі **сторонніх Claude-чатів** (старі роадмапи, ідеї) **не в репо** і недоступні асистенту. Власник підкладе їх у `docs/_harvest_inbox/` (або вставить), після чого сесія-жнив прогонить по них **ту саму рубрику §1** і доповнить список §2.
