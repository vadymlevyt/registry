...
Рядок у дужках [...] після маркера — структурні підказки сторінки
(заголовок, футер-№, СКИДАННЯ-НУМЕРАЦІЇ, орієнтація): сильні сигнали
початку нового документа. Використовуй їх для визначення меж.
