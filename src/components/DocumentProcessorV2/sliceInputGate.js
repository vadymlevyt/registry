...
// з підказкою увімкнути «Просто додати файли». Це закриває дві діри входу:
...
const MSG_TOO_SMALL =
  "Малий PDF — схоже текстовий або одиночний документ. Для додавання як є увімкніть „Просто додати файли”";
