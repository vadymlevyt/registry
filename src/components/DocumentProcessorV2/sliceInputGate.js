...
// з підказкою вимкнути «Нарізати том на документи» (= просто-додати). Це закриває дві діри входу:
...
const MSG_NON_PDF =
  "Нарізка приймає лише сканований PDF. Для Word / інших форматів вимкніть „Нарізати том на документи”";
const MSG_TOO_SMALL =
  "Малий PDF — схоже текстовий або одиночний документ. Для додавання як є вимкніть „Нарізати том на документи”";
